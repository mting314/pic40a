...
<body>
    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td><input type="checkbox" class="boxes" name="check-1"></td>
                    <td><input type="checkbox" class="boxes" name="check-2"></td>
                    <td><input type="checkbox" class="boxes" name="check-3"></td>
                    <td><input type="checkbox" class="boxes" name="check-4"></td>
                    <td><input type="checkbox" class="boxes" name="check-5"></td>
                    <td><input type="checkbox" class="boxes" name="check-6"></td>
                    <td><input type="checkbox" class="boxes" name="check-7"></td>
                    <td><input type="checkbox" class="boxes" name="check-8"></td>
                    <td><input type="checkbox" class="boxes" name="check-9"></td>
                </tr>
            </tbody>
        </table>
        <fieldset>
